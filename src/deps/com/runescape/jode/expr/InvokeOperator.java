...
import com.runescape.jode.GlobalOptions;
import com.runescape.jode.bytecode.*;
import com.runescape.jode.decompiler.*;
import com.runescape.jode.jvm.Interpreter;
import com.runescape.jode.jvm.InterpreterException;
import com.runescape.jode.jvm.SimpleRuntimeEnvironment;
import com.runescape.jode.jvm.SyntheticAnalyzer;
import com.runescape.jode.type.*;
import com.runescape.jode.util.SimpleMap;
...
public final class InvokeOperator extends Operator implements MatchableOperator {
    ...
    public void makeNonVoid() {
        if (type != Type.tVoid)
            throw new com.runescape.jode.AssertError("already non void");
            ...
            */
            ...
            while (callee != ana.getClazz()) {
                ...
                if (ana.getParent() instanceof MethodAnalyzer && (Options.options & Options.OPTION_ANON) != 0)
                    ...
                    throw new com.runescape.jode.AssertError("Unknown parent: " + ana + ": " + ana.getParent());
            }
        }
