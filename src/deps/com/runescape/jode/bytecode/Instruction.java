...
package com.runescape.jode.bytecode;
...
public final class Instruction implements Opcodes {
  ...
  :: "Instruction has no values" } }*/ {
    ...
    void removePredecessor(Instruction pred) {
        ...
        if (predLength == 1) {
            if (preds[0] != pred)
                throw new com.runescape.jode.AssertError("removing not existing predecessor");
            preds = null;
        } else {
    ...
    /*{ require { poppush != null && poppush.length == 2
        ...
        if (delta < 0x40) {
            ...
            switch (opcode) {
                ...
                default:
                    throw new com.runescape.jode.AssertError("Unknown Opcode: " + opcode);
            }
        }
    }
