...
import com.runescape.jode.expr.LocalStoreOperator;
import com.runescape.jode.expr.StoreInstruction;
...
public class SequentialBlock extends StructuredBlock {
    ...
    public void checkConsistent() {
        ...
        if (subBlocks[0].jump != null || subBlocks[0] instanceof SequentialBlock || jump != null)
            throw new com.runescape.jode.AssertError("Inconsistency");
    }
    ...
    public VariableStack mapStackToLocal(VariableStack stack) {
        if (stack == null)
            com.runescape.jode.GlobalOptions.err.println("map stack to local called with null: " + this + " in " + this.flowBlock);
        ...
        com.runescape.jode.GlobalOptions.err.println("Dead code after Block " + subBlocks[0]);
        return null;
    }
