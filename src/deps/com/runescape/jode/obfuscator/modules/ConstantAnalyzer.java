 ...
 *
 * $Id: ConstantAnalyzer.java.in,v 1.3.2.6 2002/05/28 17:34:16 hoenicke Exp $
 */
...
import com.runescape.jode.obfuscator.*;
    ...
    private static class StackLocalInfo implements ConstantListener {
        ...
        public void merge(StackLocalInfo other) {
            ...
            if (stack.length != other.stack.length)
                throw new com.runescape.jode.AssertError("stack length differs");
            for (int i = 0; i < stack.length; i++) {
                if ((other.stack[i] == null) != (stack[i] == null))
                    throw new com.runescape.jode.AssertError("stack types differ");
                ...
                if (known) {
                    ...
                    switch (opcode) {
                        ...
                        case opc_drem:
                            ...
                            break;
                        default:
                            throw new com.runescape.jode.AssertError("Can't happen.");
                    }
            ...
            case opc_invokevirtual: {
                ...
                if (constant) {
                    try {
                        ...
                        constant = false;
                        if (com.runescape.jode.GlobalOptions.verboseLevel > 3)
