...
import com.runescape.jode.bytecode.InnerClassInfo;
import com.runescape.jode.bytecode.MethodInfo;
import com.runescape.jode.expr.Expression;
import com.runescape.jode.expr.ThisOperator;
import com.runescape.jode.flow.StructuredBlock;
import com.runescape.jode.flow.TransformConstructors;
import com.runescape.jode.type.MethodType;
        ...
        if (parent != null) {
            ...
            if (outerInfos[0].outer == null || outerInfos[0].name == null) {
                if (parent instanceof ClassAnalyzer)
                    throw new com.runescape.jode.AssertError("ClassInfo Attributes are inconsistent: " + clazz.getName());
            } else {
