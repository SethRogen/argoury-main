...
import com.runescape.jode.flow.FlowBlock;
import com.runescape.jode.flow.Jump;
import com.runescape.jode.flow.StructuredBlock;
import com.runescape.jode.flow.TransformExceptionHandlers;
import com.runescape.jode.jvm.CodeVerifier;
import com.runescape.jode.jvm.SyntheticAnalyzer;
import com.runescape.jode.jvm.VerifyException;
...
public class MethodAnalyzer implements Scope, ClassDeclarer {
        ...
        TransformExceptionHandlers excHandlers;
        {
            ...
            */
            ...
            for (Iterator i = code.getInstructions().iterator(); i.hasNext(); ) {
                ...
                com.runescape.jode.flow.StructuredBlock block = Opcodes.readOpcode(instr, this);
        ...
        if (code != null) {
            if ((Options.options & Options.OPTION_VERIFY) != 0) {
                ...
                try {
                    ...
                    throw new com.runescape.jode.AssertError("Verification error");
                }
            }
    ...
    public boolean skipWriting() {
       ...
       * and mustn't throw exceptions */
        if (getMethodHeader() == null || !(getMethodHeader().getBlock() instanceof com.runescape.jode.flow.EmptyBlock) || !getMethodHeader().hasNoJumps() || exceptions.length > 0)
            return false;
