...
public class ItemOnItemHandler extends PlayerFrameHandler {
    ...
    public void handleFrame(Player player, IoSession session, Frame frame) {
        ...
        if (interfaceId1 == 149 && interfaceId2 == 149) {
            ...
            logger.warn("Item on item performed with different interfaces! Please check which " + "interface is which and refactor this properly in " + "com.runescape.adapter.protocol.handler.ItemOnItemHandler");
    }
}
