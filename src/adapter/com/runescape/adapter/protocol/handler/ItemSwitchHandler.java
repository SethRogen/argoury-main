...
public class ItemSwitchHandler extends PlayerFrameHandler {
    ...
    public void handleFrame(Player player, IoSession session, Frame frame) {
        ...
        if (interfaceId1 != interfaceId2) {
            logger.warn("Item switch performed with different interfaces! Please check which " + "interface is which and refactor this properly in " + "com.runescape.adapter.protocol.handler.ItemSwitchHandler");
        }
    }
}
