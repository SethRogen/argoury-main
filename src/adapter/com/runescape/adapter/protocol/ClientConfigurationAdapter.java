...
public class ClientConfigurationAdapter implements ClientConfiguration {
	...
	public RegistrationResponse getRegistrationResponseForCode(int code) {
		...
		case 21:
	        return RegistrationResponse.INVALID_DETAILS;
		case 15:
	        return RegistrationResponse.IP_BANNED;
		case 2:
	        return RegistrationResponse.REGISTRATION_COMPLETE;
		case 37: 
			return RegistrationResponse.SERVER_UPDATED;
		}
