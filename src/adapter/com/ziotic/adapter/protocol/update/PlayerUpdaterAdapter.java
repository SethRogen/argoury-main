...
public final class PlayerUpdaterAdapter implements PlayerUpdater {
    ...
    public Frame doApperanceBlock(Player player) {
        ...
        appearanceBlock.writeByte(player.getLevels().getCombatLevel()); // combat
        appearanceBlock.writeByte(player.getLevels().getCombatLevel()); //level
        appearanceBlock.writeByte(-1); //this sets minigame levels
        appearanceBlock.writeByte(0); //transformId?
