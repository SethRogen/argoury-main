...
public abstract class PrayerManager implements ButtonHandler {
    ...
    public void load() throws IOException {
        ...
        try {
             ...
             */
            curseDefinitions = (Map<Integer, AncientCurseDefinition>) Static.xml.readObject(Static.parseString("%WORK_DIR%/world/miscData/ancientcurses.xml"));
            prayerDefinitions = (Map<Integer, PrayerDefinition>) Static.xml.readObject(Static.parseString("%WORK_DIR%/world/miscData/prayers.xml"));
