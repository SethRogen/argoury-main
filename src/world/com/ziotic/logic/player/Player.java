...
public class Player extends Entity implements PlayerType, Destroyable {
    ...
    public static final Tile NOOB_SPAWN_POINT = Tile.locate(3088, 3501, 0);
    
    public static final Tile DEFAULT_SPAWN_POINT = Tile.locate(3088, 3501, 0);
    ...
    public Tile spawnPoint() {
        if (noob && onLogin) {
            return NOOB_SPAWN_POINT.randomize(2, 1);
        }
        return DEFAULT_SPAWN_POINT.randomize(2, 1);
    }
