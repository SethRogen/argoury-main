...
import com.runescape.content.skill.HarvestingTick;
...
public class Woodcutting implements ActionHandler, ObjectOptionHandler {
    ...
    static int BirdNestFallen = 1997;
    ...
    public static class WoodcuttingTick extends HarvestingTick {
        ...
        public void onReward() {
    		...
    		if (random.nextInt(5) == 0) {
    			//TODO: add birdnest fallen sounds
    			Static.world.getGroundItemManager().add(BIRD_NESTS[random.nextInt(BIRD_NESTS.length)], 1, player.getLocation(), player.getProtocolName(), false);
    			 if (tree == Tree.IVY) {
    			 		Static.proto.sendMessage(player, "<col=FF0000>A bird's nest falls out of the ivy.");
    			 	} else {
    			 		Static.proto.sendMessage(player, "<col=FF0000>A bird's nest falls out of the tree.");
    			  }
       			 stop(true);
