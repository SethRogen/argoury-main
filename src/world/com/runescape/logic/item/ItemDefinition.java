...
public class ItemDefinition {
    ...
    public static void loadEquipmentIds() {
        try {
            try {
                equipmentIds = Static.xml.readObject(Static.parseString("%WORK_DIR%/world/items/equipids.xml"));
            } catch (IOException e) {
                ...
                Static.xml.writeObject(equipmentIds, Static.parseString("%WORK_DIR%/world/items/equipids.xml"));
            }
