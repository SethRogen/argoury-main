...
import com.runescape.content.skill.member.summoning.SummoningPouch;
...
public final class World implements Runnable {
    ...
    private void loadNPCsAndCorrespondingRegions() {
        ...
        try {
            List<NPCSpawn> spawns = Static.xml.readObject(Static.parseString("%WORK_DIR%/world/npc/npcspawns.xml"));
